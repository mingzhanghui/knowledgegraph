...
NREUM.info = {
  ...
  "licenseKey": "7dc04976a0",
  "applicationID": "15009246",
  "applicationTime": 78.117143,
  "transactionName": "Z10AZEZSD0VTUExYCV4XJ0hEQQRFQVlLHiF1bE0fHhkMTx1QUFAURBdYXlVeBA==",
  "queueTime": 0,
  "ttGuid": "2024dbcb32d22a",
  "agentToken": null
};
window.NREUM || (NREUM = {}), __nr_require = function (e, t, n) {
  ...
  1: [function (e, t, n) {
    ...
    function o(e) {
      ...
      var v = {}, y = {}, b = {on: l, emit: n, get: w, listeners: m, context: t, buffer: g, abort: a, aborted: !1};
      return b
    }
    ...
    var u = (new Date).getTime(), c = e("handle"), f = e(2), s = e("ee"), p = window, d = p.document, l = "addEventListener", m = "attachEvent", w = p.XMLHttpRequest, g = w && w.prototype;
    NREUM.o = {
      ST: setTimeout,
      SI: p.setImmediate,
      CT: clearTimeout,
    ...
    }, b = w && g && g[l] && !/CriOS/.test(navigator.userAgent), h = t.exports = {
      offset: u,
      now: a,
      origin: v,
      features: {},

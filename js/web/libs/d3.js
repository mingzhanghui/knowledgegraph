...
!function() {
    ...
    function r(n) {
        return {
            left: function(t, r, e, u) {
                for (arguments.length < 3 && (e = 0),
                     arguments.length < 4 && (u = t.length); u > e; ) {
                    var i = e + u >>> 1;
                    n(t[i], r) < 0 ? e = i + 1 : u = i
                }
                return e
    ...
    function x() {
        for (var n, t = d3.event; n = t.sourceEvent; )
            t = n;
        return t
    }
    function M(n) {
    ...
    function E(n) {
        return new RegExp("(?:^|\\s+)" + d3.requote(n) + "(?:\\s+|$)","g")
    }
    function A(n) {
    ...
    function N(n) {
        ...
        return function(r, e) {
            ...
            e ? (t.lastIndex = 0,
            t.test(u) || r.setAttribute("class", k(u + " " + n))) : r.setAttribute("class", k(u.replace(t, " ")))
        }
    }
    function z(n, t, r) {
        function e() {
    ...
    function T(n) {
        return "function" == typeof n ? n : (n = d3.ns.qualify(n)).local ? function() {
    ...
    function F(n, t, r) {
        ...
        function i() {
            var t, r = new RegExp("^__on([^.]+)" + d3.requote(n) + "$");
            for (var e in this)
                if (t = e.match(r)) {
                    var u = this[e];
    ...
    function Y() {
        var n = ".dragsuppress-" + ++Sa
            , t = "click" + n
            , r = d3.select(Win).on("touchmove" + n, y).on("dragstart" + n, y).on("selectstart" + n, y);
        if (wa) {
            var e = DE.style
                , u = e[wa];
            e[wa] = "none"
    ...
    function _t(n, t, r) {
        ...
        return (i = $a.get(n)) ? t(i.r, i.g, i.b) : (null == n || "#" !== n.charAt(0) || isNaN(i = parseInt(n.substring(1), 16)) || (4 === n.length ? (o = (3840 & i) >> 4,
            o = o >> 4 | o,
            a = 240 & i,
            a = a >> 4 | a,
            c = 15 & i,
    ...
    function bt(n, t, r) {
        ...
        return a ? (u = .5 > c ? a / (o + i) : a / (2 - o - i),
            e = n == o ? (t - r) / a + (r > t ? 6 : 0) : t == o ? (r - n) / a + 2 : (n - t) / a + 4,
            e *= 60) : (e = 0 / 0,
            u = c > 0 && 1 > c ? 0 : e),
            et(e, u, c)
    }
    ...
    function Ct(n) {
        return function(t, r, e) {
            return 2 === arguments.length && "function" == typeof r && (e = r,
                r = null),
                Nt(t, r, n, e)
        }
    }
    function Nt(n, t, r, e) {
        ...
        var i = {}
            , o = d3.dispatch("beforesend", "progress", "load", "error")
            , a = {}
            , c = new XMLHttpRequest
            , s = null;
        return !Win.XDomainRequest || "withCredentials"in c || !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest),
            ...
            i.send = function(r, e, u) {
                if (2 === arguments.length && "function" == typeof e && (u = e,
                        e = null),
                        c.open(r, n, !0),
    ...
    function Lt() {
        var n = Tt()
            , t = qt() - n;
        t > 24 ? (isFinite(t) && (clearTimeout(Wa),
            Wa = setTimeout(Lt, t)),
            Ja = 0) : (Ja = 1,
            Ka(Lt))
    }
    ...
    function qt() {
        for (var n, t = Xa, r = 1 / 0; t; )
            t.f ? t = n ? n.n = t.n : Xa = t.n : (t.t < r && (r = t.t),
                t = (n = t).n);
        return Ba = n,
            r
    }
    ...
    function Ot(n) {
        function t(n) {
            ...
            return t.parse = function(t) {
                ...
                var i = null != e.Z && ec !== jt
                    , o = new (i ? jt : ec);
                return "j"in e ? o.setFullYear(e.y, 0, e.j) : "w"in e && ("W"in e || "U"in e) ? (o.setFullYear(e.y, 0, 1),
                    o.setFullYear(e.y, 0, "W"in e ? (e.w + 6) % 7 + 7 * e.W - (o.getDay() + 5) % 7 : e.w + 7 * e.U - (o.getDay() + 6) % 7)) : o.setFullYear(e.y, e.m, e.d),
        ...
        function e(n, t, r) {
            ...
            return e ? (n.w = w.get(e[0].toLowerCase()),
            r + e[0].length) : -1
        }
        function u(n, t, r) {
            M.lastIndex = 0;
            var e = M.exec(t.substring(r));
            return e ? (n.w = _.get(e[0].toLowerCase()),
            r + e[0].length) : -1
        }
        function i(n, t, r) {
            E.lastIndex = 0;
            var e = E.exec(t.substring(r));
            return e ? (n.m = A.get(e[0].toLowerCase()),
            r + e[0].length) : -1
        }
        function o(n, t, r) {
            S.lastIndex = 0;
            var e = S.exec(t.substring(r));
            return e ? (n.m = k.get(e[0].toLowerCase()),
            r + e[0].length) : -1
        }
        function a(n, t, e) {
    ...
    function Yt(n) {
        return new RegExp("^(?:" + n.map(d3.requote).join("|") + ")","i")
    }
    function Zt(n) {
    ...
    function Wt(n, t, r) {
        return /^[+-]\d{4}$/.test(t = t.substring(r, r + 5)) ? (n.Z = -t,
        r + 5) : -1
    }
    function Gt(n) {
            ...
            var g, p, v, d = t(i), m = u.invert(e[0], e[1]), y = {
                ...
                polygonEnd: function() {
                    ...
                    g.length ? (_ || (i.polygonStart(),
                        _ = !0),
                        Cr(g, Rr, n, r, i)) : n && (_ || (i.polygonStart(),
                        _ = !0),
                        i.lineStart(),
                        r(null, null, 1, i),
                        i.lineEnd()),
            ...
            if (l)
                for (var f = s[0], h = f[0], g = f[1] / 2 + ka / 4, p = Math.sin(g), v = Math.cos(g), d = 1; ; ) {
                    ...
                    var m = n[0]
                        ...
                        , S = w > ka
                        , k = p * x;
                    if (gc.add(Math.atan2(k * b * Math.sin(w), v * M + k * Math.cos(w))),
                            i += S ? _ + b * Ea : _,
                        S ^ h >= r ^ m >= r) {
                        var E = dr(pr(f), pr(n));
                        xr(E);
    ...
    function Pr(n) {
        ...
        return {
            ...
            point: function(i, o) {
                var a = i > 0 ? ka : -ka
                    , c = ca(i - r);
                ca(c - ka) < Ca ? (n.point(r, e = (e + o) / 2 > 0 ? Aa : -Aa),
                    n.point(u, e),
                    n.lineEnd(),
                    n.lineStart(),
                    n.point(a, e),
                    n.point(i, e),
                    t = 0) : u !== a && c >= ka && (ca(r - u) < Ca && (r -= u * Ca),
                ca(i - a) < Ca && (i -= a * Ca),
                    e = Ur(r, e, i, o),
                    n.point(u, e),
                    n.lineEnd(),
        ...
        function r(n) {
            ...
            return {
                ...
                point: function(f, h) {
                    ...
                    if (!r && (s = c = v) && n.lineStart(),
                        v !== c && (g = e(r, p),
                        (_r(r, g) || _r(p, g)) && (p[0] += Ca,
                            p[1] += Ca,
                            v = t(p[0], p[1]))),
                        v !== c)
                        l = 0,
        ...
        function e(n, t, r) {
            ...
            if (!(0 > x)) {
                ...
                if (!C && k > E && (b = k,
                        k = E,
                        E = b),
                        N ? C ? k + E > 0 ^ _[1] < (ca(_[0] - w) < Ca ? k : E) : k <= _[1] && _[1] <= E : A > ka ^ (w <= _[0] && _[0] <= S)) {
                    var z = yr(d, (-m + M) / y);
                    return mr(z, p),
                        [_, Mr(z)]
                }
        ...
        function u(t, r, e, a, c, s, l, f, h, g, p, v, d, m) {
            ...
            if (M > 4 * i && d--) {
                var _ = a + g
                    ...
                    , L = N - r
                    , T = x * z - y * L;
                (T * T / M > i || ca((y * z + x * L) / M - .5) > .3 || o > a * g + c * p + s * v) && (u(t, r, e, a, c, s, C, N, E, _ /= S, b /= S, w, d, m),
                    m.point(C, N),
    ...
    function ie(n) {
        ...
        return t.stream = function(n) {
            ...
            ,
            t.center = function(n) {
                return arguments.length ? (v = n[0] % 360 * za,
                    d = n[1] % 360 * za,
                    e()) : [v * La, d * La]
            }
            ,
            t.rotate = function(n) {
                return arguments.length ? (m = n[0] % 360 * za,
                    y = n[1] % 360 * za,
                    x = n.length > 2 ? n[2] % 360 * za : 0,
                    e()) : [m * La, y * La, x * La]
            }
            ,
            d3.rebind(t, f, "precision"),
            function() {
    ...
    function ve(n, t, r) {
        var e = d3.range(n, t - Ca, r).concat(t);
        return function(n) {
        ...
        if (Bc.insert(t, c),
            ...
            if (t === r)
                return $e(t),
                    ...
                    void 0;
            if (!r)
                return c.edge = We(t.site, c.site),
                    void 0;
            $e(t),
                $e(r);
            var s = t.site
    ...
    function Xe(n) {
        for (var t, r = $c, e = Fr(n[0][0], n[0][1], n[1][0], n[1][1]), u = r.length; u--; )
            t = r[u],
            (!Be(t, n) || !e(t) || ca(t.a.x - t.b.x) < Ca && ca(t.a.y - t.b.y) < Ca) && (t.a = t.b = null,
                r.splice(u, 1))
    }
    function Be(n, t) {
        var r = n.b;
    ...
    function Ke(n, t, r, e) {
        n.a || n.b ? n.l === r ? n.b = e : n.a = e : (n.a = e,
            n.l = t,
            n.r = r)
    }
    function Qe(n, t, r) {
    ...
    function vu(n, t) {
        ...
        for (n += "",
                 t += ""; (r = ns.exec(n)) && (e = ts.exec(t)); )
            (u = e.index) > i && (u = t.substring(i, u),
                a[o] ? a[o] += u : a[++o] = u),
                (r = r[0]) === (e = e[0]) ? a[o] ? a[o] += e : a[++o] = e : (a[++o] = null,
                    c.push({
                        i: o,
                        x: pu(r, e)
                    })),
    ...
    function du(n, t) {
        for (var r, e = d3.interpolators.length; --e >= 0 && !(r = d3.interpolators[e](n, t)); )
            ;
        return r
    }
    function mu(n, t) {
    ...
    function Cu(n, t) {
        ...
        return arguments.length < 2 && (t = .45),
            arguments.length ? r = t / Ea * Math.asin(1 / n) : (n = 1,
                r = t / 4),
            function(e) {
    ...
    function Lu(n, t) {
        ...
        return isNaN(o) && (o = 0,
            e = isNaN(e) ? t.c : e),
            isNaN(i) ? (i = 0,
                r = isNaN(r) ? t.h : r) : i > 180 ? i -= 360 : -180 > i && (i += 360),
            function(n) {
    ...
    function Hu(n, t) {
        var r, e = [], u = [], i = d3.transform(n), o = d3.transform(t), a = i.translate, c = o.translate, s = i.rotate, l = o.rotate, f = i.skew, h = o.skew, g = i.scale, p = o.scale;
        return a[0] != c[0] || a[1] != c[1] ? (e.push("translate(", null, ",", null, ")"),
            u.push({
                i: 1,
                x: pu(a[0], c[0])
            }, {
            ...
            g[0] != p[0] || g[1] != p[1] ? (r = e.push(e.pop() + "scale(", null, ",", null, ")"),
                u.push({
                    i: r - 4,
                    x: pu(g[0], p[0])
                }, {
    ...
    function Wu(n, t) {
        return d3.rebind(n, t, "sort", "children", "value"),
            n.nodes = n,
            n.links = ri,
            n
    }
    ...
    function ri(n) {
        return d3.merge(n.map(function(n) {
        ...
        if ((r = n.children) && (s = r.length)) {
            ...
            if (r.forEach(xi),
                ...
                for (i = r[2],
                    ...
                    if (1 == p)
                        for (c = e._pack_prev; c !== a._pack_prev && !mi(c, i); c = c._pack_prev,
                            d++)
                            ;
                    p ? (d > v || v == d && u.r < e.r ? di(e, u = a) : di(e = c, u),
                        o--) : (vi(e, i),
                        u = i,
                        t(i))
                }
    ...
    function Ii(n, t) {
        return d3.rebind(n, t, "range", "rangeRound", "interpolate", "clamp")
    }
    function Yi(n, t) {
    ...
    function Vi(n, t) {
        return d3.range.apply(d3, Zi(n, t))
    }
    function $i(n, t, r) {
        var e = Zi(n, t);
        if (r) {
            ...
            if (u.shift(),
                "s" === u[8]) {
                var i = d3.formatPrefix(Math.max(ca(e[0]), ca(e[1])));
    ...
    function Ji(n, t, r, e) {
        ...
        return o.invert = function(t) {
            ...
            o.tickFormat = function(n, t) {
                if (!arguments.length)
                    return ps;
                arguments.length < 2 ? t = ps : "function" != typeof t && (t = d3.format(t));
                var e, a = Math.max(.1, n / o.ticks().length), c = r ? (e = 1e-12,
                    Math.ceil) : (e = -1e-12,
                    Math.floor);
                return function(n) {
    ...
    function Wi(n, t, r) {
        ...
        return e.invert = function(t) {
            ...
            ,
            e.domain = function(t) {
                return arguments.length ? (n.domain((r = t.map(Number)).map(u)),
                    e) : r
            }
            ,
            e.ticks = function(n) {
    ...
    function Ki(n, t) {
        ...
        function e(t, r) {
            return d3.range(n.length).map(function(n) {
                return t + r * n
            })
        }
        var u, i, a;
    ...
    function Qi(r, e) {
        function u() {
            var n = 0
                , t = e.length;
            for (o = []; ++n < t; )
                o[n - 1] = d3.quantile(r, n / t);
            return i
        }
        function i(n) {
            return isNaN(n = +n) ? void 0 : e[d3.bisect(o, n)]
        }
        var o;
        return i.domain = function(e) {
            return arguments.length ? (r = e.filter(t).sort(n),
                u()) : r
        }
            ,
            i.range = function(n) {
    ...
    function to(n, t) {
        function r(r) {
            return r >= r ? t[d3.bisect(n, r)] : void 0
        }
    ...
    function ro(n) {
        ...
        return t.invert = t,
            t.domain = t.range = function(r) {
                return arguments.length ? (n = r.map(t),
                    t) : n
            }
            ,
            t.ticks = function(t) {
    ...
    function ao(n) {
        ...
        return t.x = function(n) {
            ...
            t.interpolate = function(n) {
                return arguments.length ? (o = "function" == typeof n ? i = n : (i = bs.get(n) || co).key,
                    t) : o
            }
            ,
    ...
    function mo(n, t) {
        ...
        var r = n.length != t.length
            ...
            , a = o
            , c = 1;
        if (r && (e += "Q" + (i[0] - 2 * o[0] / 3) + "," + (i[1] - 2 * o[1] / 3) + "," + i[0] + "," + i[1],
                u = n[1],
                c = 2),
            t.length > 1) {
            a = t[1],
    ...
    function zo(n) {
        ...
        return t.x = function(n) {
            ...
            ,
            t.interpolate = function(n) {
                return arguments.length ? (c = "function" == typeof n ? a = n : (a = bs.get(n) || co).key,
                    s = a.reverse || a,
                    l = a.closed ? "M" : "L",
                    t) : c
            }
    ...
    function Fo(n, t, r, e) {
        ...
        if (!i) {
            ...
            i = u[r] = {
                ...
                d3.timer(function(e) {
                    function o(e) {
                        return u.active > r ? s() : (u.active = r,
    ...
    var Doc = document, DE = Doc.documentElement, Win = window;
    try {
        Wo(DE.childNodes)[0].nodeType;
    } catch (na) {
        Wo = function(n) {
    ...
    try {
        ...
        var ra = Win.Element.prototype
            , ea = ra.setAttribute
            , ua = ra.setAttributeNS
            , ia = Win.CSSStyleDeclaration.prototype
            , oa = ia.setProperty;
    ...
    d3.ascending = n,
        ...
        ,
        d3.median = function(r, e) {
            return arguments.length > 1 && (r = r.map(e)),
                r = r.filter(t),
                r.length ? d3.quantile(r.sort(n), .5) : void 0
        }
    ;
    var aa = r(n);
    d3.bisectLeft = aa.left,
        d3.bisect = d3.bisectRight = aa.right,
        ...
        d3.zip = function() {
            if (!(u = arguments.length))
                return [];
            for (var n = -1, t = d3.min(arguments, e), r = new Array(t); ++n < t; )
                for (var u, i = -1, o = r[n] = new Array(u); ++i < u; )
                    o[i] = arguments[i][n];
            return r
        }
        ,
        d3.transpose = function(n) {
            return d3.zip.apply(d3, n)
        }
        ,
        d3.keys = function(n) {
            var t = [];
    ...
    }, da = DE[p(DE, "matchesSelector")], ma = function(n, t) {
        return da.call(n, t)
    };
    ...
    ya.select = function(n) {
        ...
        for (var o = -1, a = this.length; ++o < a; ) {
            ...
            for (var c = -1, s = e.length; ++c < s; )
                (u = e[c]) ? (t.push(r = n.call(u, u.__data__, c, o)),
                r && "__data__"in u && (r.__data__ = u.__data__)) : t.push(null)
        }
        return _(i)
    }
        ,
        ya.selectAll = function(n) {
            ...
            for (var u = -1, i = this.length; ++u < i; )
                for (var o = this[u], a = -1, c = o.length; ++a < c; )
                    (r = o[a]) && (e.push(t = Wo(n.call(r, r.__data__, a, u))),
                        t.parentNode = r);
            return _(e)
        }
    ;
    ...
    d3.ns = {
        ...
        ya.style = function(n, t, r) {
            ...
            if (3 > e) {
                ...
                if (2 > e)
                    return Win.getComputedStyle(this.node(), null).getPropertyValue(n);
                r = ""
            }
        ...
        ya.order = function() {
            for (var n = -1, t = this.length; ++n < t; )
                for (var r, e = this[n], u = e.length - 1, i = e[u]; --u >= 0; )
                    (r = e[u]) && (i && i !== r.nextSibling && i.parentNode.insertBefore(r, i),
                        i = r);
            return this
        }
        ,
    ...
    ;
    var Ma = [];
    d3.selection.enter = U,
        d3.selection.enter.prototype = Ma,
        Ma.append = ya.append,
        Ma.empty = ya.empty,
        Ma.node = ya.node,
        Ma.call = ya.call,
        ...
        Ma.select = function(n) {
            for (var t, r, e, u, i, o = [], a = -1, c = this.length; ++a < c; ) {
                ...
                for (var s = -1, l = u.length; ++s < l; )
                    (i = u[s]) ? (t.push(e[s] = r = n.call(u.parentNode, i.__data__, s, a)),
        ...
        ,
        d3.select = function(n) {
            var t = ["string" == typeof n ? pa(n, Doc) : n];
            return t.parentNode = DE,
                _([t])
        }
        ,
        d3.selectAll = function(n) {
            var t = Wo("string" == typeof n ? va(n, Doc) : n);
            return t.parentNode = DE,
                _([t])
        }
    ;
    ...
    ba.forEach(function(n) {
        "on" + n in Doc && ba.remove(n)
    });
    var wa = "onselectstart"in Doc ? null : p(DE.style, "userSelect")
        , Sa = 0;
    d3.mouse = function(n) {
        return Z(n, x())
    }
        ,
        d3.touches = function(n, t) {
        ...
        d3.behavior.drag = function() {
                ...
                return function() {
                    ...
                    function c() {
                        t(h, v) && (m.on(i + d, null).on(o + d, null),
                            y(p && d3.event.target === f),
                            g({
                                type: "dragend"
                            }))
                    }
                    var s, l = this, f = d3.event.target, h = l.parentNode, g = r.of(l, arguments), p = 0, v = n(), d = ".drag" + (null == v ? "" : "-" + v), m = d3.select(u()).on(i + d, a).on(o + d, c), y = Y(), x = t(h, v);
                    e ? (s = e.apply(l, arguments),
            ...
            var r = M(n, "drag", "dragstart", "dragend")
                , e = null
                , u = t(v, d3.mouse, X, "mousemove", "mouseup")
                , i = t(V, d3.touch, $, "touchmove", "touchend");
    ...
    var ka = Math.PI
        ...
        , qa = 2
        , Ra = 4;
    d3.interpolateZoom = function(n, t) {
        function r(n) {
            var t = n * y;
            if (m) {
                var r = Q(v)
        ...
        d3.behavior.zoom = function() {
            ...
            function s() {
                ...
                function r() {
                    f.on(C, Win === e ? h : null).on(N, null),
                        p(l && d3.event.target === i),
                        c(s)
                }
                var e = this
                    , i = d3.event.target
            ...
            function l() {
                ...
                function r() {
                    ...
                    d3.select(t).on(M, i).on(_, f),
                        b.push(t);
                    for (var r = d3.event.changedTouches, o = 0, c = r.length; c > o; ++o)
                ...
                function i() {
                    for (var n, t, r, i, o = d3.touches(g), c = 0, s = o.length; s > c; ++c,
                        i = null)
                        if (r = o[c],
                                i = v[r.identifier]) {
                            if (t)
                ...
                function f() {
                    if (d3.event.touches.length) {
                        for (var t = d3.event.changedTouches, r = 0, e = t.length; e > r; ++r)
                            delete v[t[r].identifier];
                        for (var u in v)
                            return void n()
                    }
                    d3.selectAll(b).on(x, null),
                        w.on(A, s).on(z, l),
                        k(),
                        c(p)
                }
                var h, g = this, p = L.of(g, arguments), v = {}, d = 0, x = ".zoom-" + d3.event.changedTouches[0].identifier, M = "touchmove" + x, _ = "touchend" + x, b = [], w = d3.select(g).on(A, null).on(z, r), k = Y();
                H.call(g),
                    r(),
                    o(p)
            }
            ...
            function g() {
                ...
                o(n),
                    e(Math.pow(2, d3.event.shiftKey ? Math.ceil(s) - 1 : Math.floor(s) + 1)),
                    u(r, i),
                    a(n),
                    c(n)
            }
            ...
            return n.event = function(n) {
                n.each(function() {
                    var n = L.of(this, arguments)
                        , t = S;
                    As ? d3.select(this).transition().each("start.zoom", function() {
                        S = this.__chart__ || {
                                x: 0,
                                y: 0,
                                k: 1
                        ...
                        var r = k[0]
                            ...
                            , u = r / 2
                            , i = e / 2
                            , o = d3.interpolateZoom([(u - S.x) / S.k, (i - S.y) / S.k, r / S.k], [(u - t.x) / t.k, (i - t.y) / t.k, r / t.k]);
                        return function(t) {
                            var e = o(t)
                                , c = r / e[2];
                            this.__chart__ = S = {
    ...
    ;
    var Da, Pa = [0, 1 / 0], Ua = "onwheel"in Doc ? (Da = function() {
        return -d3.event.deltaY * (d3.event.deltaMode ? 120 : 1)
    }
        ,
        "wheel") : "onmousewheel"in Doc ? (Da = function() {
    ...
    ja.brighter = function(n) {
        ...
        ,
        d3.hcl = function(n, t, r) {
            return 1 === arguments.length ? n instanceof at ? ot(n.h, n.c, n.l) : n instanceof lt ? ht(n.l, n.a, n.b) : ht((n = wt((n = d3.rgb(n)).r, n.g, n.b)).l, n.a, n.b) : ot(+n, +t, +r)
        }
    ;
    ...
    Ha.brighter = function(n) {
        ...
        ,
        d3.lab = function(n, t, r) {
            return 1 === arguments.length ? n instanceof lt ? st(n.l, n.a, n.b) : n instanceof at ? ct(n.l, n.c, n.h) : wt((n = d3.rgb(n)).r, n.g, n.b) : st(+n, +t, +r)
        }
    ;
    var Fa = 18
        , Oa = .95047
    ...
    Va.brighter = function(n) {
        ...
        var t = this.r
            ...
            , e = this.b
            , u = 30;
        return t || r || e ? (t && u > t && (t = u),
        r && u > r && (r = u),
        e && u > e && (e = u),
            yt(Math.min(255, ~~(t / n)), Math.min(255, ~~(r / n)), Math.min(255, ~~(e / n)))) : yt(u, u, u)
    }
        ,
                ...
                r.parseRows = function(n, t) {
                    function r() {
                        ...
                        if (34 === n.charCodeAt(t)) {
                            ...
                            return 13 === e ? (u = !0,
                            10 === n.charCodeAt(r + 2) && ++l) : 10 === e && (u = !0),
    ...
    ;
    var Xa, Ba, Ja, Wa, Ga, Ka = Win[p(Win, "requestAnimationFrame")] || function(n) {
                setTimeout(n, 17)
            }
        ;
    d3.timer = function(n, t, r) {
        var e = arguments.length;
        2 > e && (t = 0),
        3 > e && (r = Date.now());
        var u = r + t
        ...
        ,
        d3.round = function(n, t) {
            return t ? Math.round(n * (t = Math.pow(10, t))) / t : Math.round(n)
        }
    ;
    var Qa = ["y", "z", "a", "f", "p", "n", "\xb5", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(Dt);
    d3.formatPrefix = function(n, t) {
        var r = 0;
        return n && (0 > n && (n *= -1),
        t && (n = d3.round(n, Rt(n, t))),
    ...
    var nc = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i
        ...
        r: function(n, t) {
            return (n = d3.round(n, Rt(n, t))).toFixed(Math.max(0, Math.min(20, Rt(n * (1 + 1e-15), t))))
        }
    })
        , rc = d3.time = {}
        , ec = Date;
    ...
    d3.geo.bounds = function() {
        ...
        return function(n) {
            ...
            if (t) {
                ...
                for (var r, e = 1, u = x[0], i = [u]; t > e; ++e)
                    r = x[e],
                        s(r[0], u) || s(r[1], u) ? (a(u[0], r[1]) > a(u[0], u[1]) && (u[1] = r[1]),
                        a(r[0], u[1]) > a(u[0], u[1]) && (u[0] = r[0])) : i.push(u = r);
                for (var o, r, p = -1 / 0, t = i.length - 1, e = 0, u = i[t]; t >= e; u = r,
                    ++e)
                    r = i[e],
                    (o = a(u[1], r[0])) > p && (p = o,
                        l = r[0],
        ...
        d3.geo.centroid = function(n) {
            ...
            Ca > dc && (t = mc,
                ...
                e = xc),
                u = t * t + r * r + e * e,
            Na > u) ? [0 / 0, 0 / 0] : [Math.atan2(r, t) * La, G(e / Math.sqrt(u)) * La]
        }
    ;
    ...
    d3.geo.clipExtent = function() {
        var n, t, r, e, u, i, o = {
            ...
            extent: function(a) {
                return arguments.length ? (i = Or(n = +a[0][0], t = +a[0][1], r = +a[1][0], e = +a[1][1]),
                u && (u.valid = !1,
                    u = null),
                    o) : [[n, t], [r, e]]
            }
        ...
        d3.geo.albersUsa = function() {
            ...
            var t, r, e, u, i = d3.geo.albers(), o = d3.geo.conicEqualArea().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), a = d3.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), c = {
                point: function(n, r) {
                    t = [n, r]
                }
            };
    ...
    d3.geo.path = function() {
        ...
        return n.area = function(n) {
            return Nc = 0,
                d3.geo.stream(n, u(Dc)),
                Nc
        }
            ,
            n.centroid = function(n) {
                return mc = yc = xc = Mc = _c = bc = wc = Sc = kc = 0,
                    d3.geo.stream(n, u(Uc)),
                    kc ? [wc / kc, Sc / kc] : bc ? [Mc / bc, _c / bc] : xc ? [mc / xc, yc / xc] : [0 / 0, 0 / 0]
            }
            ,
            n.bounds = function(n) {
                return qc = Rc = -(Lc = Tc = 1 / 0),
                    d3.geo.stream(n, u(Pc)),
                    [[Lc, Tc], [qc, Rc]]
            }
            ,
            n.projection = function(n) {
                return arguments.length ? (u = (r = n) ? n.stream || te(n) : At,
                    t()) : r
            }
            ,
            n.context = function(n) {
                return arguments.length ? (i = null == (e = n) ? new Xr : new Qr(n),
            ...
            ,
            n.projection(d3.geo.albersUsa()).context(null)
    }
        ,
        d3.geo.transform = function(n) {
            return {
                stream: function(t) {
                    var r = new re(t);
                    for (var e in n)
        ...
        d3.geo.projection = ue,
        d3.geo.projectionMutator = ie,
        (d3.geo.equirectangular = function() {
                return ue(ae)
            }
        ).raw = ae.invert = ae,
        d3.geo.rotation = function(n) {
            function t(t) {
        ...
        d3.geo.circle = function() {
            ...
            return n.origin = function(t) {
                ...
                ,
                n.angle = function(e) {
                    return arguments.length ? (r = ge((t = +e) * za, u * za),
                        n) : t
                }
                ,
                n.precision = function(e) {
                    return arguments.length ? (r = ge(t * za, (u = +e) * za),
                        n) : u
                }
                ,
                n.angle(90)
        ...
        d3.geo.graticule = function() {
            ...
            function t() {
                return d3.range(Math.ceil(i / d) * d, u, d).map(h).concat(d3.range(Math.ceil(s / m) * m, c, m).map(g)).concat(d3.range(Math.ceil(e / p) * p, r, p).filter(function(n) {
                    return ca(n % d) > Ca
                }).map(l)).concat(d3.range(Math.ceil(a / v) * v, o, v).filter(function(n) {
                    return ca(n % m) > Ca
                }).map(f))
            }
        ...
        d3.geo.greatArc = function() {
            ...
            return n.distance = function() {
                return d3.geo.distance(t || e.apply(this, arguments), r || u.apply(this, arguments))
            }
                ,
                n.source = function(r) {
                    return arguments.length ? (e = r,
                        t = "function" == typeof r ? null : r,
                        n) : e
                }
                ,
                n.target = function(t) {
        ...
        ,
        d3.geo.interpolate = function(n, t) {
            return xe(n[0] * za, n[1] * za, t[0] * za, t[1] * za)
        }
        ,
        d3.geo.length = function(n) {
            return jc = 0,
                d3.geo.stream(n, Hc),
                jc
        }
    ...
    (d3.geo.stereographic = function() {
        ...
        (d3.geo.transverseMercator = function() {
                ...
                return n.center = function(n) {
                    ...
                    ,
                    n.rotate = function(n) {
                        return n ? r([n[0], n[1], n.length > 2 ? n[2] + 90 : 90]) : (n = r(),
                            [n[0], n[1], n[2] - 90])
                    }
                    ,
                    n.rotate([0, 0])
        ...
        ,
        d3.geom.polygon = function(n) {
            return ga(n, Vc),
                n
        }
    ;
    var Vc = d3.geom.polygon.prototype = [];
    Vc.area = function() {
        ...
        Vc.clip = function(n) {
            for (var t, r, e, u, i, o, a = qe(n), c = -1, s = this.length - qe(this), l = this[s - 1]; ++c < s; ) {
                for (t = n.slice(),
                         ...
                         r = -1; ++r < e; )
                    o = t[r],
                        Le(o, l, u) ? (Le(i, l, u) || n.push(Te(i, o, l, u)),
                            n.push(o)) : Le(i, l, u) && n.push(Te(i, o, l, u)),
                        i = o;
                a && n.push(n[0]),
                    l = u
            }
    ...
    Oe.prototype.prepare = function() {
        ...
        d3.geom.voronoi = function(n) {
            ...
            return n ? t(n) : (t.links = function(n) {
                ...
                ,
                t.x = function(n) {
                    return arguments.length ? (i = Et(e = n),
                        t) : e
                }
                ,
                t.y = function(n) {
    ...
    d3.geom.delaunay = function(n) {
        return d3.geom.voronoi().triangles(n)
    }
        ,
        d3.geom.quadtree = function(n, t, r, e, u) {
            function i(n) {
            ...
            3 === o && (u = r,
                ...
                ,
                i.extent = function(n) {
                    return arguments.length ? (null == n ? t = r = e = u = null : (t = +n[0][0],
                        r = +n[0][1],
                        e = +n[1][0],
                        u = +n[1][1]),
                        i) : null == t ? null : [[t, r], [e, u]]
                }
                ,
                i.size = function(n) {
                    return arguments.length ? (null == n ? t = r = e = u = null : (t = r = 0,
                        e = +n[0],
                        u = +n[1]),
                        i) : null == t ? null : [e - t, u - r]
                }
                ,
                i)
        }
        ,
        d3.interpolateRgb = hu,
        d3.interpolateObject = gu,
        d3.interpolateNumber = pu,
        d3.interpolateString = vu;
    var ns = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g
        , ts = new RegExp(ns.source,"g");
    d3.interpolate = du,
        d3.interpolators = [function(n, t) {
            var r = typeof t;
            return ("string" === r ? $a.has(t) || /^(#|rgb\(|hsl\()/.test(t) ? hu : vu : t instanceof rt ? hu : Array.isArray(t) ? mu : "object" === r && isNaN(t) ? gu : pu)(n, t)
        }
        ],
        d3.interpolateArray = mu;
    var rs = function() {
        return At
    }
        , es = d3.map({
    ...
    d3.ease = function(n) {
        ...
        ,
        d3.interpolateHcl = Lu,
        d3.interpolateHsl = Tu,
        d3.interpolateLab = qu,
        d3.interpolateRound = Ru,
        d3.transform = function(n) {
            var t = Doc.createElementNS(d3.ns.prefix.svg, "g");
            return (d3.transform = function(n) {
                    if (null != n) {
    ...
    d3.interpolateTransform = Hu,
        ...
        d3.layout.chord = function() {
            function n() {
                var n, s, f, h, g, p = {}, v = [], d = d3.range(i), m = [];
                for (r = [],
                         e = [],
                         n = 0,
                         h = -1; ++h < i; ) {
        ...
        d3.layout.force = function() {
            ...
            var r, e, u, i, o, a = {}, c = d3.dispatch("start", "tick", "end"), s = [1, 1], l = .9, f = os, h = as, g = -30, p = cs, v = .1, d = .64, m = [], y = [];
            return a.tick = function() {
                ...
                for (r = 0; b > r; ++r)
                    a = y[r],
                        ...
                        x = h.x - f.x,
                        M = h.y - f.y,
                    (p = x * x + M * M) && (p = e * i[r] * ((p = Math.sqrt(p)) - u[r]) / p,
                        x *= p,
                        M *= p,
                ...
                if ((d = e * v) && (x = s[0] / 2,
                    ...
                    for (; ++r < _; )
                        a = m[r],
                            ...
                            a.y += (M - a.y) * d;
                if (g)
                    for (Ju(t = d3.geom.quadtree(m), e, o),
                             r = -1; ++r < _; )
                ...
                ,
                a.drag = function() {
                    return r || (r = d3.behavior.drag().origin(At).on("dragstart.force", Vu).on("drag.force", t).on("dragend.force", $u)),
                        arguments.length ? (this.on("mouseover.force", Xu).on("mouseout.force", Bu).call(r),
                            void 0) : r
                }
                ,
                d3.rebind(a, c, "on")
    ...
    d3.layout.hierarchy = function() {
        function n(u) {
            ...
            for (u.depth = 0; null != (i = o.pop()); )
                if (a.push(i),
                    (s = r.call(n, i, i.depth)) && (c = s.length)) {
                    for (var c, s, l; --c >= 0; )
                        o.push(l = s[c]),
                            l.parent = i,
                            l.depth = i.depth + 1;
        ...
        d3.layout.pie = function() {
            function n(i) {
                var o = i.map(function(r, e) {
                    ...
                    , c = (("function" == typeof u ? u.apply(this, arguments) : u) - a) / d3.sum(o)
                    , s = d3.range(i.length);
    ...
    d3.layout.stack = function() {
        ...
        return n.values = function(r) {
            ...
            ,
            n.order = function(t) {
                return arguments.length ? (r = "function" == typeof t ? t : ls.get(t) || oi,
                    n) : r
            }
            ,
            n.offset = function(t) {
                return arguments.length ? (e = "function" == typeof t ? t : fs.get(t) || ai,
                    n) : e
            }
            ,
            n.x = function(t) {
    ...
    var ls = d3.map({
        "inside-out": function(n) {
            var t, r, e = n.length, u = n.map(ci), i = n.map(si), o = d3.range(e).sort(function(n, t) {
                return u[n] - u[t]
            }), a = 0, c = 0, s = [], l = [];
            for (t = 0; e > t; ++t)
                r = o[t],
        ...
        reverse: function(n) {
            return d3.range(n.length).reverse()
        },
        "default": oi
    })
        , fs = d3.map({
        ...
        wiggle: function(n) {
            ...
            for (g[0] = c = s = 0,
                ...
                for (t = 0,
                         i = 0,
                         a = f[r][0] - f[r - 1][0]; l > t; ++t) {
                    for (e = 0,
                             o = (n[t][r][1] - n[t][r - 1][1]) / (2 * a); t > e; ++e)
    ...
    d3.layout.histogram = function() {
        function n(n, i) {
            ...
            if (g > 0)
                for (i = -1; ++i < h; )
                    a = s[i],
                    a >= l[0] && a <= l[1] && (o = c[d3.bisect(f, a, 1, g) - 1],
                        o.y += p,
                        o.push(n[i]));
            return c
        }
        ...
        d3.layout.pack = function() {
            ...
            var t, r = d3.layout.hierarchy().sort(pi), e = 0, u = [1, 1];
            return n.size = function(t) {
                ...
                ,
                n.radius = function(r) {
                    return arguments.length ? (t = null == r || "function" == typeof r ? r : +r,
                        n) : t
                }
                ,
        ...
        d3.layout.tree = function() {
            ...
            function u(n, t, r) {
                if (t) {
                    for (var e, u = n, i = n, o = t, c = u.parent.children[0], s = u.m, l = i.m, f = o.m, h = c.m; o = ki(o),
                        u = Si(u),
                    o && u; )
                        c = Si(c),
                            i = ki(i),
            ...
            var o = d3.layout.hierarchy().sort(null).value(null)
                , a = wi
                , c = [1, 1]
                , s = null;
        ...
        d3.layout.cluster = function() {
            ...
            return n.separation = function(t) {
                ...
                ,
                n.size = function(t) {
                    return arguments.length ? (u = null == (e = t),
                        n) : u ? null : e
                }
                ,
                n.nodeSize = function(t) {
        ...
        d3.layout.treemap = function() {
            ...
            function t(r) {
                ...
                if (i && i.length) {
                    ...
                    for (n(h, s.dx * s.dy / r.value),
                             l.area = 0; (c = h.length) > 0; )
                        l.push(o = h[c - 1]),
                            l.area += o.area,
                            "squarify" !== g || (a = e(l, v)) <= p ? (h.pop(),
            ...
            var o, a = d3.layout.hierarchy(), c = Math.round, s = [1, 1], l = null, f = qi, h = !1, g = "squarify", p = .5 * (1 + Math.sqrt(5));
            return i.size = function(n) {
                ...
                i.padding = function(n) {
                    ...
                    if (!arguments.length)
                        return l;
                    var e;
                    return f = null == (l = n) ? qi : "function" == (e = typeof n) ? t : "number" === e ? (n = [n, n, n, n],
                        r) : r,
                        i
                }
                ,
                    ...
                    function() {
                        ...
                        do
                            r = 2 * Math.random() - 1,
                                e = 2 * Math.random() - 1,
                                u = r * r + e * e;
                        while (!u || u > 1);return n + t * r * Math.sqrt(-2 * Math.log(u) / u)
                    }
            },
            logNormal: function() {
                var n = d3.random.normal.apply(d3, arguments);
                return function() {
                    return Math.exp(n())
                }
            },
            bates: function(n) {
                var t = d3.random.irwinHall(n);
                return function() {
                    return t() / n
                }
            },
    ...
    d3.scale.log = function() {
        return Ji(d3.scale.linear().domain([0, 1]), 10, !0, [1, 10])
    }
    ;
    var ps = d3.format(".0e")
        , vs = {
    ...
    d3.scale.pow = function() {
        return Wi(d3.scale.linear(), 1, [0, 1])
    }
        ,
        ...
        d3.scale.category10 = function() {
            return d3.scale.ordinal().range(ds)
        }
        ,
        d3.scale.category20 = function() {
            return d3.scale.ordinal().range(ms)
        }
        ,
        d3.scale.category20b = function() {
            return d3.scale.ordinal().range(ys)
        }
        ,
        d3.scale.category20c = function() {
            return d3.scale.ordinal().range(xs)
        }
    ;
    ...
    d3.scale.quantile = function() {
        ...
        d3.svg.arc = function() {
            ...
            return n.innerRadius = function(r) {
                return arguments.length ? (t = Et(r),
                    n) : t
            }
                ,
    ...
    d3.svg.line.radial = function() {
        ...
        d3.svg.chord = function() {
            ...
            return n.radius = function(t) {
                ...
                ,
                n.endAngle = function(t) {
                    return arguments.length ? (s = Et(t),
                        n) : s
                }
                ,
                n
    ...
    Ls.call = ya.call,
        ...
        Ls.select = function(n) {
            ...
            for (var o = -1, a = this.length; ++o < a; ) {
                ...
                for (var c = this[o], s = -1, l = c.length; ++s < l; )
                    (e = c[s]) && (r = n.call(e, e.__data__, s, o)) ? ("__data__"in e && (r.__data__ = e.__data__),
        ...
        Ls.style = function(n, t, r) {
            ...
            function u(t) {
                return null == t ? e : (t += "",
                        function() {
                            var e, u = Win.getComputedStyle(this, null).getPropertyValue(n);
                            return u !== t && (e = du(u, t),
                                        function(t) {
        ...
        Ls.styleTween = function(n, t, r) {
            function e(e, u) {
                var i = t.call(this, e, u, Win.getComputedStyle(this, null).getPropertyValue(n));
                return i && function(t) {
        ...
        Ls.ease = function(n) {
            var t = this.id;
            return arguments.length < 1 ? this.node().__transition__[t].ease : ("function" != typeof n && (n = d3.ease.apply(d3, arguments)),
                P(this, function(r) {
        ...
        Ls.each = function(n, t) {
            ...
            if (arguments.length < 2) {
                ...
                P(this, function(e) {
                    ...
                    (u.event || (u.event = d3.dispatch("start", "end"))).on(n, t)
                });
            return this
        }
        ,
        Ls.transition = function() {
            for (var n, t, r, e, u = this.id, i = ++Ts, o = [], a = 0, c = this.length; c > a; a++) {
                ...
                for (var t = this[a], s = 0, l = t.length; l > s; s++)
                    (r = t[s]) && (e = Object.create(r.__transition__[u]),
                        e.delay += e.duration,
                        Fo(r, s, i, e)),
                        n.push(r)
            }
        ...
        d3.svg.axis = function() {
            function n(n) {
                n.each(function() {
                    var n, s = d3.select(this), l = this.__chart__ || r, f = this.__chart__ = r.copy(), h = null == c ? f.ticks ? f.ticks.apply(f, a) : f.domain() : c, g = null == t ? f.tickFormat ? f.tickFormat.apply(f, a) : At : t, p = s.selectAll(".tick").data(h, f), v = p.enter().insert("g", ".domain").attr("class", "tick").style("opacity", Ca), d = d3.transition(p.exit()).style("opacity", Ca).remove(), m = d3.transition(p.order()).style("opacity", 1), y = Pi(f), x = s.selectAll(".domain").data([0]), M = (x.enter().append("path").attr("class", "domain"),
                        d3.transition(x));
                    v.append("line"),
                        v.append("text");
                    var _ = v.select("line")
            ...
            var t, r = d3.scale.linear(), e = qs, u = 6, i = 6, o = 3, a = [10], c = null;
            return n.scale = function(t) {
                ...
                ,
                n.orient = function(t) {
                    return arguments.length ? (e = t in Rs ? t + "" : qs,
                        n) : e
                }
                ,
                n.ticks = function() {
    ...
    d3.svg.brush = function() {
        function n(i) {
            i.each(function() {
                var i = d3.select(this).style("pointer-events", "all").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)").on("mousedown.brush", u).on("touchstart.brush", u)
                ...
                var l, f = d3.transition(i), h = d3.transition(o);
                c && (l = Pi(c),
        ...
        function u() {
            ...
            function p() {
                32 == d3.event.keyCode && 2 == C && (z[0] += l[1],
                    z[1] += f[1],
                    C = 0,
                    y())
            }
            function v() {
                ...
                M && (n[0] += M[0],
                    n[1] += M[1]),
                C || (d3.event.altKey ? (x || (x = [(l[0] + l[1]) / 2, (f[0] + f[1]) / 2]),
                    z[0] = l[+(n[0] < x[0])],
            ...
            function d(n, t, r) {
                ...
                return C && (c -= p,
                    ...
                    C ? u = (e += p) + d : (x && (p = Math.max(c, Math.min(s, 2 * x[r] - e))),
                        e > p ? (u = e,
                            e = p) : u = p),
                    v[0] != e || v[1] != u ? (r ? o = null : i = null,
                        v[0] = e,
                        v[1] = u,
                        !0) : void 0
            }
            ...
            var x, M, _ = this, b = d3.select(d3.event.target), w = a.of(_, arguments), S = d3.select(_), k = b.datum(), E = !/^(n|s)$/.test(k) && c, A = !/^(e|w)$/.test(k) && s, C = b.classed("extent"), N = Y(), z = d3.mouse(_), L = d3.select(Win).on("keydown.brush", u).on("keyup.brush", p);
            if (d3.event.changedTouches ? L.on("touchmove.brush", v).on("touchend.brush", m) : L.on("mousemove.brush", v).on("mouseup.brush", m),
                ...
                d3.event.altKey && (x = z.slice());
            S.style("pointer-events", "none").selectAll(".resize").style("display", null),
                d3.select("body").style("cursor", b.style("cursor")),
                w({
                    type: "brushstart"
                }),
                v()
        ...
        return n.event = function(n) {
            n.each(function() {
                var n = a.of(this, arguments)
                    ...
                    , r = this.__chart__ || t;
                this.__chart__ = t,
                    As ? d3.select(this).transition().each("start.brush", function() {
                        i = r.i,
                            o = r.j,
                            l = r.x,
                            f = r.y,
            ...
            n.extent = function(t) {
                var r, e, u, a, h;
                return arguments.length ? (c && (r = t[0],
                    e = t[1],
                s && (r = r[0],
                    e = e[0]),
                    i = [r, e],
    ...
    var Fs = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6]
        ...
        range: function(n, t, r) {
            return d3.range(Math.ceil(n / r) * r, +t, r).map(Vo)
        },
        floor: At,
        ceil: At
    };
    Os.year = rc.year,
        rc.scale = function() {
            return Zo(d3.scale.linear(), Os, Is)
        }
    ;
    ...
    Zs.year = rc.year.utc,
        rc.scale.utc = function() {
            return Zo(d3.scale.linear(), Zs, Vs)
        }
        ,
        d3.text = Ct(function(n) {
            return n.responseText
        }),
        d3.json = function(n, t) {
            return Nt(n, "application/json", $o, t)
        }
        ,
        d3.html = function(n, t) {
            return Nt(n, "text/html", Xo, t)
        }
        ,
        d3.xml = Ct(function(n) {
